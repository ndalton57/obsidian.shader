...
--------------------------------------------------------------------------------
  ...
  step's field (waveSim2) with movement compensation, integrates pressure and
  velocity, injects the splash source under the player/vehicle and writes the
  intermediate field (waveSim)
